...
\item In short lived flows/bursty networks, can Vivace meaningfully minimise regret?
\end{itemize}
...
% Both are designed in mind for worst-case safety rather than average-case.
